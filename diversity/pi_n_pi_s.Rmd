...
unbiased <- DE_c %>% filter(log2FoldChange <= 0.419 & log2FoldChange > -0.354 ) # 6150
unbiased <- unbiased %>% filter(padj >= 0.1) # 4680
...
stats_unbiased <- inner_join(unbiased, stats, by="gene") # 4319 3309
...
write.table(stats_unbiased, file = paste0(directory,"stats_unbiased2.txt"), sep = "\t", row.names = FALSE, quote = FALSE)
...
directory="/Users/yuanmeng/Library/CloudStorage/OneDrive-UniversityofToronto/Manuscripts/ceratodon_haploid_sel/diversity/"
write.table(pi_genes_c, file = paste0(directory,"specific_genes_pi2.txt"), row.names = FALSE, sep = "\t", quote = FALSE)
...
#unbias <- DE_tissue %>% filter(padj >= 0.1) # 858
```
...
statsr_unbiased <- inner_join(unbias, statsr, by="gene") # 532 523
...
pi_unbiased_r <- bootstrap_calculate_pi(statsr_unbiased)
pi_unbiased_r$category <- "unbiased" 

pi_genes_r <- rbind(pi_genesp, pi_genesl, pi_unbiased_r)
directory="/Users/yuanmeng/Library/CloudStorage/OneDrive-UniversityofToronto/Manuscripts/rumex_haploid_sel/pixy/"
write.table(pi_genes_r, file = paste0(directory,"specific_genes_pi2.txt"), row.names = FALSE, sep = "\t", quote = FALSE)
...
p4_2 <- ggplot(data = pi_genes_c_real, mapping = aes(x=category, y=mean_avg_pi_syn)) + 
    geom_point()+ geom_errorbar(aes(ymin=mean_avg_pi_syn - sem_avg_pi_syn, ymax=mean_avg_pi_syn + sem_avg_pi_syn), width=.2, position=position_dodge(.9))+ ggtitle("d-2") +labs(y ="pi_syn")+ theme_classic() + theme(text = element_text(size = 10),axis.title.x=element_blank())

p5_2 <- ggplot(data = pi_genes_c_real, mapping = aes(x=category, y=mean_avg_pi_nonsyn)) + 
    geom_point()+ geom_errorbar(aes(ymin=mean_avg_pi_nonsyn - sem_avg_pi_nonsyn, ymax=mean_avg_pi_nonsyn + sem_avg_pi_nonsyn), width=.2, position=position_dodge(.9))+ ggtitle("e-2") +labs(y ="pi_nonsyn")+ theme_classic() + theme(text = element_text(size = 10),axis.title.x=element_blank())
...
p1_2 <- ggplot(data = pi_genes_r_real, mapping = aes(x=category, y=mean_avg_pi_syn)) + 
    geom_point()+ geom_errorbar(aes(ymin=mean_avg_pi_syn - sem_avg_pi_syn, ymax=mean_avg_pi_syn + sem_avg_pi_syn), width=.2, position=position_dodge(.9))+ ggtitle("a-2") +labs(y ="pi_syn mean")+ theme_classic() + theme(text = element_text(size = 10),axis.title.x=element_blank())

p2_2 <- ggplot(data = pi_genes_r_real, mapping = aes(x=category, y=mean_avg_pi_nonsyn)) + 
    geom_point()+ geom_errorbar(aes(ymin=mean_avg_pi_nonsyn - sem_avg_pi_nonsyn, ymax=mean_avg_pi_nonsyn + sem_avg_pi_nonsyn), width=.2, position=position_dodge(.9))+ ggtitle("b-2") +labs(y ="pi_nonsyn")+ theme_classic() + theme(text = element_text(size = 10),axis.title.x=element_blank())
...
p1 <- ggplot(data = pi_genes_r_real, mapping = aes(x=category, y=mean_avg_pi_syn)) + 
    geom_point()+ geom_errorbar(aes(ymin=mean_avg_pi_syn - sem_avg_pi_syn, ymax=mean_avg_pi_syn + sem_avg_pi_syn), width=.2, position=position_dodge(.9))+ ggtitle("a") +labs(y ="pi_syn mean")+ theme_classic() + theme(text = element_text(size = 10),axis.title.x=element_blank())

p1_1 <- ggplot(data = pi_genes_r, mapping = aes(x=category, y=mean_pi_syn)) + 
    geom_point()+ geom_errorbar(aes(ymin=lower_pi_syn, ymax=higher_pi_syn), width=.2, position=position_dodge(.9))+ ggtitle("a") +labs(y ="pi_syn weighted mean")+ theme_classic() + theme(text = element_text(size = 10),axis.title.x=element_blank())
