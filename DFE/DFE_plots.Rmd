...
write.table(prop, file = paste0(directory,"final_prop_qt_Oct.txt"), row.names = F, quote = F)
```
...
write.table(prop, file = paste0(directory,"final_prop_Oct.txt"), row.names = F, quote = F,sep = "\t")
```
