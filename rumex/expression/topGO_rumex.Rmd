...
balsel_gene_noInversion <- read.table("/Users/yuanmeng/Library/CloudStorage/OneDrive-UniversityofToronto/Manuscripts/rumex_haploid_sel/balsel/inversion_genes.txt", header = T) # 138
balsel_gene_noInversion <- balsel_gene_noInversion[complete.cases(balsel_gene_noInversion),] # 128
