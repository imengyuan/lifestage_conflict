...
write.table(l_specific[,c(13:15)],file=paste0(directory,"l_specific_noTE.bed"),sep="\t",row.names = FALSE, col.names = FALSE, quote=FALSE)
write.table(p_specific[,c(13:15)],file=paste0(directory,"p_specific_noTE.bed"),sep="\t",row.names = FALSE, col.names = FALSE, quote=FALSE)
...
scatterplot of all genes expressed
```{r}
